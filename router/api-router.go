...
func SetApiRouter(router *gin.Engine) {
	...
	registerTokenBillRoutes(apiRouter)
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		{
			organizationRoute.GET("/self", controller.GetOrganizationSelf)
			organizationRoute.GET("/current", controller.GetCurrentOrganization)
			organizationRoute.PATCH("/current", controller.UpdateCurrentOrganization)
			organizationRoute.GET("/current/members", controller.GetCurrentOrganizationMembers)
			organizationRoute.POST("/current/members", controller.AddCurrentOrganizationMember)
			organizationRoute.PATCH("/current/members/:user_id", controller.UpdateCurrentOrganizationMember)
			organizationRoute.DELETE("/current/members/:user_id", controller.DeleteCurrentOrganizationMember)
			organizationRoute.GET("/current/billing/summary", controller.GetCurrentOrganizationBillingSummary)
			organizationRoute.GET("/current/billing/members", controller.GetCurrentOrganizationBillingMembers)
			organizationRoute.GET("/current/billing/models", controller.GetCurrentOrganizationBillingModels)
			organizationRoute.GET("/current/billing/channels", controller.GetCurrentOrganizationBillingChannels)
			...
			organizationRoute.GET("/current/billing/logs/display-export", controller.ExportCurrentOrganizationBillingDisplayLogs)
			organizationRoute.GET("/current/billing/export", controller.ExportCurrentOrganizationBilling)
			organizationRoute.GET("/current/invoice", controller.GetCurrentOrganizationInvoice)
			organizationRoute.GET("/current/invoice/export", controller.ExportCurrentOrganizationInvoice)
			organizationRoute.GET("/current/invoice/settlement-rules", controller.GetCurrentOrganizationSettlementRules)
			organizationRoute.PUT("/current/invoice/settlement-rules", controller.UpdateCurrentOrganizationSettlementRule)
		...
		{
			adminOrganizationRoute.GET("/", controller.AdminListOrganizations)
			adminOrganizationRoute.POST("/", controller.AdminCreateOrganization)
			adminOrganizationRoute.GET("/:id", controller.AdminGetOrganization)
			adminOrganizationRoute.PATCH("/:id", controller.AdminUpdateOrganization)
			adminOrganizationRoute.GET("/:id/members", controller.AdminListOrganizationMembers)
			adminOrganizationRoute.POST("/:id/members", controller.AdminAddOrganizationMember)
			adminOrganizationRoute.PATCH("/:id/members/:user_id", controller.AdminUpdateOrganizationMember)
			adminOrganizationRoute.DELETE("/:id/members/:user_id", controller.AdminDeleteOrganizationMember)
			adminOrganizationRoute.GET("/:id/billing/summary", controller.AdminGetOrganizationBillingSummary)
			adminOrganizationRoute.GET("/:id/billing/members", controller.AdminGetOrganizationBillingMembers)
			adminOrganizationRoute.GET("/:id/billing/models", controller.AdminGetOrganizationBillingModels)
			adminOrganizationRoute.GET("/:id/billing/channels", controller.AdminGetOrganizationBillingChannels)
			...
			adminOrganizationRoute.GET("/:id/billing/logs/display-export", controller.AdminExportOrganizationBillingDisplayLogs)
			adminOrganizationRoute.GET("/:id/billing/export", controller.AdminExportOrganizationBilling)
			adminOrganizationRoute.GET("/:id/invoice", controller.AdminGetOrganizationInvoice)
			adminOrganizationRoute.GET("/:id/invoice/export", controller.AdminExportOrganizationInvoice)
			adminOrganizationRoute.GET("/:id/invoice/settlement-rules", controller.AdminGetOrganizationSettlementRules)
			adminOrganizationRoute.PUT("/:id/invoice/settlement-rules", controller.AdminUpdateOrganizationSettlementRule)
